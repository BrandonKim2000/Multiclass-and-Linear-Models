...
from binary import *
from util import *
# Importing from what ELMS says I need to import
...
class MCTree:
    ...
    def train(self, X, Y):
        for n in self.tree.iterNodes():
            ...
            thisX = numpy.array(thisX)
            thisY = numpy.array(thisY)
    ...
    def predict(self, X):
        ...
        while not node.isLeaf:
            probabilities = node.getNodeInfo().predict_proba(X.reshape(1, -1))
